...
def event_catalog_entries() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "status": "implemented",
            "schema": "schemas/events/booking.cancelled.json",
            "avro": None,
            "publishers": ["CancelBookingHandler"],
            "consumers": ["WorkflowEngine", "PushHandlers"],
        },
        {
        ...
        },
        {
            ...
            "schema": None,
            "avro": None,
            "publishers": ["CompleteBookingHandler"],
            "consumers": ["WorkflowEngine", "PushHandlers"],
        },
        {
            ...
            "schema": None,
            "avro": None,
            "publishers": ["MarkNoShowBookingHandler"],
            "consumers": ["WorkflowEngine", "PushHandlers"],
        },
        {
            ...
            "schema": None,
            "avro": None,
            "publishers": ["ExpireBookingHandler"],
            "consumers": ["WorkflowEngine"],
        },
        {
            ...
            "schema": None,
            "avro": None,
            "publishers": ["CreateResourceHandler"],
            "consumers": [],
        },
        {
            ...
            "schema": None,
            "avro": None,
            "publishers": ["UpdateResourceHandler", "DeactivateResourceHandler"],
            "consumers": [],
        },
        {

...
def booking_completed(
    ...
    """
    Factory para evento booking.completed (R4-F13 / ADR-026).
...
def booking_no_show(
    ...
    """
    Factory para evento booking.no_show (R4-F13 / ADR-026).
...
def booking_expired(
    ...
    """
    Factory para evento booking.expired (R4-F13 / ADR-026).

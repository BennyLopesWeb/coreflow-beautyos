...
class CoreCanaryPromotion(Base):
    ...
    segment = Column(String(255), nullable=False, index=True)
    previous_branch = Column(String(255), nullable=False)
    promoted_branch = Column(String(255), nullable=False)
    production_channel = Column(String(255), nullable=False)

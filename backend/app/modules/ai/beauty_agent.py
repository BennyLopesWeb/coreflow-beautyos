"""
BeautyAgent — protótipo de agente IA CoreFlow para o plugin BeautyOS.

Orquestra análises CRM/atendimento com base no manifest do plugin e delega
execução ao ``AgenteService`` legado até a AI Platform completa (CF-8+).
"""

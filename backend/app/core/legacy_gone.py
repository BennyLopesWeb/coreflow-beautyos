...
# Rotas de pagamento legado — R4-F9/F10/F14
# Prefixos cobrem todo o antigo surface HTTP (routers removidos em R4-F14).
PAYMENT_LEGACY_GONE_ROUTES: Tuple[LegacyGoneRoute, ...] = (
    LegacyGoneRoute("/pagamentos", "/v1/payments"),
    LegacyGoneRoute("/payments", "/v1/payments"),
)

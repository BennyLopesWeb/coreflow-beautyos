...
**Release atual:** `2.8.0-r4-f5` · R4-F5 Implemented (tech) · próximo: R4-F6 (migrar `Payment`/`Schedule` legado para o core e então executar o drop físico de `agendamentos`/`payments`/`schedules`)

...
**Release atual:** `2.9.0-r4-f6` · R4-F6 Implemented (tech) · próximo: R4-F7 (DROP físico de `agendamentos`/`payments`/`schedules` legado e FKs associadas — `Schedule`/`SatisfactionSurvey` ainda referenciam `agendamentos`)
